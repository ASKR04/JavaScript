...
| EventWeave | Accessible event filters | 2026-09-14 | Composable actor, type, outcome, and inclusive duration filters with canonical ordering, synchronized selection, explicit empty states, and responsive controls | Lumen branch `codex/lumen-eventweave-event-filters` |
