...
| EventWeave | Filter interface and second failure fixture | 2026-09-21 | Shared timeline/table filtering, explicit empty state, and profile-save failure sample with parser coverage | Lumen branch `codex/lumen-eventweave-filter-interface`, review pending |
